	...
	<body>
		<div class="content">
			<div class="report">
				...
				<?php
					echo "
						<p align='center' style='color:red;'> ! Please check the NSN dashboard status before proceeding !</p>
						<div class='processPanel'>
							<form name='nsnDsh' method='POST' action='dataProcessor.php'>
									<input type='text' class='jdpicker' name='date' value='" . $inputDate ."'> <br>
									<input type='submit' name='nsnDsh' value='Process Missing NSN Data' class='button'>
							</form>
						</div>
						" ;		
				?>
