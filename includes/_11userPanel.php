						...
						<td>
							<form name="overNetworkElement" method="POST" action="analysisResults.php">
									<table border="0">
										...
										<tr>
											<td colspan="3" style="text-align:center;color:RED;">&quot;Network&quot;&nbsp;category doesn't need a category name.</td>
										</tr>
										<tr>
											<td colspan="3" align="right"><input type="submit" name="analyticalData2D" value="Search" class="button"></td>
										</tr>
									</table>
							</form>
						</td>
