		...
		<div class="content">
			<div class="report">
				<table align="center" border=0>
					<tr>
						<td colspan="2"><h1>Make your choice and press search average data</h1></td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							<form name="overTime" method="POST" action="analysisResults3.php">
								<table>
									<tr>
									...
									<tr>
										<td colspan="2">Select pre-defined date range for average calculation</td>
									</tr>
									<tr>
										<td colspan="2">
											<input type="radio" name="rangeSelector" value="none" checked="checked"><label>&nbsp;None</label>
											<input type="radio" name="rangeSelector" value="3days"><label>&nbsp;03 days</label>
											<input type="radio" name="rangeSelector" value="5days"><label>&nbsp;05 days</label>
											<input type="radio" name="rangeSelector" value="7days"><label>&nbsp;07 days</label>
										</td>
									</tr>
									<tr><td colspan="2"><br/></td></tr>
									<tr>
										<td colspan="2">
											Active KPIs - [CDR] [CSSR] [CSBR] [SDBR] <strike>[HOSR]</strike> <strike>[SDDR]</strike>
										</td>
									</tr>
									<tr>
										<td colspan="2" align="right">
											<input type="submit" name="averageDataSearch" value="Search Average Data" class="button">
										</td>
									</tr>
								</table>							
							</form>
